      ...
      >
        ...
        {current.action ? (
          <button
            type="button"
            onClick={() => settle(true)}
            className="relative min-h-10 shrink-0 rounded-xl px-3 text-[14px] font-extrabold text-accent-soft active:opacity-70 before:absolute before:inset-x-0 before:-inset-y-0.5 before:content-['']"
          >
